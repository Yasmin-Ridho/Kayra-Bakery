            ...
            <?php if (!empty($products)): ?>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8" id="products-grid">
                    <?php foreach ($products as $product): ?>
                        <div class="product-card group bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:border-soft-pink-200"
                            ...
                            <div class="p-6">
                                <!-- Product Name -->
                                <h3 class="text-xl font-bold text-gray-800 mb-3 line-clamp-2 group-hover:text-soft-pink-600 transition-colors duration-200">
