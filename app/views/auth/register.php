...
<!-- Register Form -->
<form method="POST" action="<?= getBaseUrl() ?>/register" class="space-y-6">
    <!-- Name Field -->
    <div>
        <label for="name" class="block font-semibold text-gray-700 mb-3">
            Nama Lengkap
        </label>
        <input type="text" 
               id="name" 
    ...
    <div>
        ...
        <div class="relative">
            ...
            <button type="button" 
                ...
                <svg id="eyeOffPassword" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L3 3m6.878 6.878L21 21"/>
                </svg>
                <!-- Icon mata terbuka (hidden) -->
                <svg id="eyeOnPassword" class="h-5 w-5 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div>
        <label for="confirm_password" class="block font-semibold text-gray-700 mb-3">
            Konfirmasi Password
        </label>
        <div class="relative">
            <input type="password" 
            ...
            <button type="button" 
                    ...
                    class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600 transition-colors duration-200">
                <!-- Icon mata tertutup (default) -->
                <svg id="eyeOffConfirm" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L3 3m6.878 6.878L21 21"/>
                </svg>
                <!-- Icon mata terbuka (hidden) -->
                <svg id="eyeOnConfirm" class="h-5 w-5 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                </svg>
            </button>
    ...
    <div class="pt-2">
        <label class="flex items-start">
            <input type="checkbox" 
                   name="terms" 
                   required
                   class="w-4 h-4 text-gray-600 border-gray-300 rounded focus:ring-gray-300 focus:ring-2 mt-1">
            <span class="ml-3 text-gray-600 font-medium text-sm leading-relaxed">
                Saya setuju dengan <a href="#" class="text-soft-pink-500 hover:text-soft-pink-600 transition-colors duration-200">Syarat & Ketentuan</a> 
                dan <a href="#" class="text-soft-pink-500 hover:text-soft-pink-600 transition-colors duration-200">Kebijakan Privasi</a> Kayra Bakery
            </span>
        </label>
    </div>
...
document.getElementById('toggleConfirmPassword').addEventListener('click', function() {
    ...
    if (confirmPasswordField.type === 'password') {
        ...
        eyeOnConfirm.classList.remove('hidden');
    } else {
        // Hide password
        confirmPasswordField.type = 'password';
        eyeOffConfirm.classList.remove('hidden');
        eyeOnConfirm.classList.add('hidden');
    }
});
</script>
...
$footer = '
    <div class="space-y-3">
        <p>Sudah punya akun? <a href="'.$baseUrl.'/login" class="text-soft-pink-500 hover:text-soft-pink-600 font-semibold transition-colors duration-200">Login di sini</a></p>
